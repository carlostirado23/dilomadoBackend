...
// require("./src/controllers/helpers/reporte.helper");
// require("./src/controllers/helpers/pdf.helper");
...
const rutaReportes = require("./src/routers/reportes.router");
const rutaMultimedia = require("./src/routers/multimedia.router")
...
rutaPrincipal.use(rutaReportes.indice, rutaReportes.ruta);
rutaPrincipal.use(rutaMultimedia.indice, rutaMultimedia.ruta);
